    ...
    <v-sheet id="calorieCounter" color="">
      <v-card>
        <v-toolbar class="text--center" flat>
          <v-spacer />
          <v-toolbar-title class="text--center headline font-weight-bold" color="info"
            >칼로리 다이어리 Calorie Diary
          </v-toolbar-title>
          <v-spacer />
        </v-toolbar>
        <v-divider />
        <v-expansion-panels multiple>
          <v-expansion-panel>
            ...
            <v-expansion-panel-content class="pa-0">
              ...
              <v-row
                class="item ma-0 px-4"
                width="100%"
                v-for="(BFitem, i) in BFitems"
                :key="i"
              >
                <v-col cols="3">
                  <v-text-field
          ...
          <v-expansion-panel>
            ...
            <v-expansion-panel-content class="pa-0">
              ...
              <v-row
                class="item ma-0 px-4"
                width="100%"
                v-for="(lunchItem, i) in lunchItems"
                :key="i"
              >
                <v-col cols="3">
                  <v-text-field
                    placeholder="음식 명"
                    v-model="lunchItem.name"
          ...
          <v-expansion-panel>
            ...
            <v-expansion-panel-content class="pa-0">
              ...
              <v-row
                class="item ma-0 px-4"
                width="100%"
                v-for="(dinnerItem, i) in dinnerItems"
                :key="i"
              >
                <v-col cols="3">
                  <v-text-field
                    placeholder="음식 명"
                    v-model="dinnerItem.name"
...
function calTotals(calorieCounter) {
  calorieCounter.totalBFCalories = parseBFTotals(
    calorieCounter.BFitems,
    "calories"
  ).toFixed(2);
  ...
  calorieCounter.totalBFProtein = parseBFTotals(
    calorieCounter.BFitems,
    "protein"
  ).toFixed(2);

  calorieCounter.totalLunchCalories = parseLunchTotals(
    calorieCounter.lunchItems,
    "calories"
  ).toFixed(2);
  calorieCounter.totalLunchFat = parseLunchTotals(
    calorieCounter.lunchItems,
    "fat"
  ).toFixed(2);
  calorieCounter.totalLunchCarbs = parseLunchTotals(
    calorieCounter.lunchItems,
    "carbs"
  ).toFixed(2);
  calorieCounter.totalLunchProtein = parseLunchTotals(
    calorieCounter.lunchItems,
    "protein"
  ).toFixed(2);

  calorieCounter.totalDinnerCalories = parseDinnerTotals(
    calorieCounter.dinnerItems,
    "calories"
  ).toFixed(2);
  calorieCounter.totalDinnerFat = parseDinnerTotals(
    calorieCounter.dinnerItems,
    "fat"
  ).toFixed(2);
  calorieCounter.totalDinnerCarbs = parseDinnerTotals(
    calorieCounter.dinnerItems,
    "carbs"
  ).toFixed(2);
  calorieCounter.totalDinnerProtein = parseDinnerTotals(
    calorieCounter.dinnerItems,
    "protein"
  ).toFixed(2);

  calorieCounter.totals = parseFloat(
    calorieCounter.totalBFCalories +
      calorieCounter.totalLunchCalories +
      calorieCounter.totalDinnerCalories
  ).toFixed(2);
  calorieCounter.totalFat = parseFloat(
    calorieCounter.totalBFFat +
      calorieCounter.totalLunchFat +
      calorieCounter.totalDinnerFat
  ).toFixed(2);
  calorieCounter.totalCarbs = parseFloat(
    calorieCounter.totalBFCarbs +
      calorieCounter.totalLunchCarbs +
      calorieCounter.totalDinnerCarbs
  ).toFixed(2);
  calorieCounter.totalProtein = parseFloat(
    calorieCounter.totalBFProtein +
      calorieCounter.totalLunchProtein +
      calorieCounter.totalDinnerProtein
  ).toFixed(2);
}
...
footer.new > .theme--dark.v-input input,
